...
if (isset($_GET['MaSP'])) {
    ...
    $query = "SELECT TenSP, Gia, MaSP FROM sanpham WHERE MaSP = ?";
        ...
        <div class="container mx-auto p-4">
            <div class="flex flex-col lg:flex-row items-center justify-center">
                ...
                <div class="w-full lg:w-1/2 mt-8 lg:mt-0 lg:ml-8">
                    ...
                    <div class="flex mt-4">
                        <button class="bg-red-600 text-white px-4 py-2 rounded mr-2">
                        GỬI TIN NHẮN
                        </button>
                        <button class="bg-white text-red-600 border border-red-600 px-4 py-2 rounded">
                        Đặt hàng
                        </button>
                    </div>
                    <div class="mt-6">
            ...
            <div class="text-center text-gray-500 mt-8">
                <p>
                Trang Chủ · Dòng Trang Sức · Vàng · DVNUTVV0001Q786
                </p>
            </div>
            <div class="fixed bottom-4 right-4">
                <button class="bg-red-600 text-white p-4 rounded-full shadow-lg">
