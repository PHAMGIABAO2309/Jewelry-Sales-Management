    ...
    <main>
        <div class="container mx-auto p-4">
            <div class="text-center px-4">
                <h2 class="text-red-800 text-lg font-semibold mb-2"><?= $_SESSION['TenLoaiSanPham']; ?></h2>
                <h1 class="text-red-800 text-5xl font-bold mb-4"> <?php echo getMoTaCTDM19($conn); ?> <?= $_SESSION['TenNhanNu']; ?> </h1>
                <p class="text-gray-700 text-base max-w-2xl mx-auto"><?= $_SESSION['MoTaNhanNu']; ?></p>
            </div>
